...
void main() {
  group('TemplateResolver', () {
    ...
    test('resolves git url with explicit syntax (parsed as ref)', () {
      final location = resolver.resolve('https://github.com/felangel/mason.git#path/to/brick');
    ...
    test('resolves git url with explicit syntax and ref', () {
      final location = resolver.resolve('https://github.com/felangel/mason.git#ref:path/to/brick');
      expect(location.gitUrl, 'https://github.com/felangel/mason.git');
    ...
    test('resolves github tree url', () {
      final location = resolver.resolve('https://github.com/leehack/mcp_dart/tree/main/packages/templates/simple');
    ...
    test('resolves github tree url with complex ref', () {
      ...
      final location = resolver.resolve('https://github.com/user/repo/tree/feature/foo/path/to/brick');
    ...
    test('fallbacks to git url', () {
      final location = resolver.resolve('https://github.com/felangel/mason.git');
      expect(location.gitUrl, 'https://github.com/felangel/mason.git');
      expect(location.gitPath, isNull);
      expect(location.gitRef, isNull);
    });
