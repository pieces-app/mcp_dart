...
Future<void> generateRunnerScript(Directory outputDir, String packageName) async {
  ...
  await generator.generate(DirectoryGeneratorTarget(outputDir), vars: {'packageName': packageName});
}
