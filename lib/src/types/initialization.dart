...
class Implementation {
  ...
  const Implementation({required this.name, required this.version, this.description});
...
class ClientCapabilitiesRoots {
  ...
  const ClientCapabilitiesRoots({this.listChanged});

  factory ClientCapabilitiesRoots.fromJson(Map<String, dynamic> json) {
    return ClientCapabilitiesRoots(listChanged: json['listChanged'] as bool?);
  }

  Map<String, dynamic> toJson() => {if (listChanged != null) 'listChanged': listChanged};
}
...
class ClientElicitationForm {
  ...
  factory ClientElicitationForm.fromJson(Map<String, dynamic> json) {
    return ClientElicitationForm(applyDefaults: json['applyDefaults'] as bool?);
  }

  Map<String, dynamic> toJson() => {if (applyDefaults != null) 'applyDefaults': applyDefaults};
}
...
class ClientElicitation {
  ...
  const ClientElicitation({this.form, this.url});

  /// Creates capabilities supporting both form and URL modes.
  const ClientElicitation.all() : form = const ClientElicitationForm(), url = const ClientElicitationUrl();

  /// Creates capabilities supporting form mode only.
  const ClientElicitation.formOnly() : form = const ClientElicitationForm(), url = null;

  /// Creates capabilities supporting URL mode only.
  const ClientElicitation.urlOnly() : form = null, url = const ClientElicitationUrl();
...
class ClientCapabilitiesTasksElicitationCreate {
  ...
  factory ClientCapabilitiesTasksElicitationCreate.fromJson(Map<String, dynamic> json) {
...
class ClientCapabilitiesTasksElicitation {
  ...
  factory ClientCapabilitiesTasksElicitation.fromJson(Map<String, dynamic> json) {
    final createMap = json['create'] as Map<String, dynamic>?;
    return ClientCapabilitiesTasksElicitation(
      create: createMap != null ? ClientCapabilitiesTasksElicitationCreate.fromJson(createMap) : null,
    );
  }

  Map<String, dynamic> toJson() => {if (create != null) 'create': create!.toJson()};
}
...
class ClientCapabilitiesTasksSamplingCreateMessage {
  ...
  factory ClientCapabilitiesTasksSamplingCreateMessage.fromJson(Map<String, dynamic> json) {
  ...
  factory ClientCapabilitiesTasksSampling.fromJson(Map<String, dynamic> json) {
    ...
    return ClientCapabilitiesTasksSampling(
      createMessage: createMessageMap != null
          ? ClientCapabilitiesTasksSamplingCreateMessage.fromJson(createMessageMap)
          : null,
    );
  }

  Map<String, dynamic> toJson() => {if (createMessage != null) 'createMessage': createMessage!.toJson()};
}
...
class ClientCapabilitiesTasksRequests {
  ...
  const ClientCapabilitiesTasksRequests({this.elicitation, this.sampling});
  ...
  factory ClientCapabilitiesTasksRequests.fromJson(Map<String, dynamic> json) {
    ...
    return ClientCapabilitiesTasksRequests(
      elicitation: elicitationMap != null ? ClientCapabilitiesTasksElicitation.fromJson(elicitationMap) : null,
      sampling: samplingMap != null ? ClientCapabilitiesTasksSampling.fromJson(samplingMap) : null,
    );
  }
...
class ClientCapabilitiesTasks {
  ...
  const ClientCapabilitiesTasks({this.cancel, this.list, this.requests});
  ...
  factory ClientCapabilitiesTasks.fromJson(Map<String, dynamic> json) {
    ...
    return ClientCapabilitiesTasks(
      ...
      requests: requestsMap == null ? null : ClientCapabilitiesTasksRequests.fromJson(requestsMap),
    );
  }
...
class ClientCapabilities {
  ...
  factory ClientCapabilities.fromJson(Map<String, dynamic> json) {
    ...
    return ClientCapabilities(
      ...
      sampling: samplingMap == null ? null : ClientCapabilitiesSampling.fromJson(samplingMap),
      roots: rootsMap == null ? null : ClientCapabilitiesRoots.fromJson(rootsMap),
      elicitation: elicitationMap == null ? null : ClientElicitation.fromJson(elicitationMap),
      tasks: tasksMap == null ? null : ClientCapabilitiesTasks.fromJson(tasksMap),
      extensions: extensionsMap?.map((key, value) => MapEntry(key, Map<String, dynamic>.from(value as Map))),
    );
  }
...
class InitializeRequest {
  ...
  const InitializeRequest({required this.protocolVersion, required this.capabilities, required this.clientInfo});

  factory InitializeRequest.fromJson(Map<String, dynamic> json) => InitializeRequest(
    protocolVersion: json['protocolVersion'] as String,
    capabilities: ClientCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>),
...
class JsonRpcInitializeRequest extends JsonRpcRequest {
  ...
  JsonRpcInitializeRequest({required super.id, required this.initParams, super.meta})
  ...
  factory JsonRpcInitializeRequest.fromJson(Map<String, dynamic> json) {
    ...
    return JsonRpcInitializeRequest(id: json['id'], initParams: InitializeRequest.fromJson(paramsMap), meta: meta);
  }
}
...
class ServerCapabilitiesElicitation {
  ...
  const ServerCapabilitiesElicitation({this.form, this.url});

  /// Creates capabilities supporting both form and URL modes.
  const ServerCapabilitiesElicitation.all() : form = const ServerElicitationForm(), url = const ServerElicitationUrl();

  /// Creates capabilities supporting form mode only.
  const ServerCapabilitiesElicitation.formOnly() : form = const ServerElicitationForm(), url = null;

  /// Creates capabilities supporting URL mode only.
  const ServerCapabilitiesElicitation.urlOnly() : form = null, url = const ServerElicitationUrl();
...
class ServerCapabilitiesPrompts {
  ...
  const ServerCapabilitiesPrompts({this.listChanged});

  factory ServerCapabilitiesPrompts.fromJson(Map<String, dynamic> json) {
    return ServerCapabilitiesPrompts(listChanged: json['listChanged'] as bool?);
  }
...
class ServerCapabilitiesResources {
  ...
  const ServerCapabilitiesResources({this.subscribe, this.listChanged});
...
class ServerCapabilitiesTools {
  ...
  const ServerCapabilitiesTools({this.listChanged});

  factory ServerCapabilitiesTools.fromJson(Map<String, dynamic> json) {
    return ServerCapabilitiesTools(listChanged: json['listChanged'] as bool?);
  }
...
class ServerCapabilitiesCompletions {
  ...
  const ServerCapabilitiesCompletions({this.listChanged});

  factory ServerCapabilitiesCompletions.fromJson(Map<String, dynamic> json) {
    return ServerCapabilitiesCompletions(listChanged: json['listChanged'] as bool?);
  }
...
class ServerCapabilitiesTasks {
  ...
  const ServerCapabilitiesTasks({this.listChanged});

  factory ServerCapabilitiesTasks.fromJson(Map<String, dynamic> json) {
    return ServerCapabilitiesTasks(listChanged: json['listChanged'] as bool?);
  }
...
class ServerCapabilities {
  ...
  factory ServerCapabilities.fromJson(Map<String, dynamic> json) {
    ...
    return ServerCapabilities(
      ...
      resources: rMap == null ? null : ServerCapabilitiesResources.fromJson(rMap),
      tools: tMap == null ? null : ServerCapabilitiesTools.fromJson(tMap),
      completions: cMap == null ? null : ServerCapabilitiesCompletions.fromJson(cMap),
      tasks: tasksMap == null ? null : ServerCapabilitiesTasks.fromJson(tasksMap),
      elicitation: elicitationMap == null ? null : ServerCapabilitiesElicitation.fromJson(elicitationMap),
      extensions: extensionsMap?.map((key, value) => MapEntry(key, Map<String, dynamic>.from(value as Map))),
    );
  }
...
class JsonRpcInitializedNotification extends JsonRpcNotification {
  const JsonRpcInitializedNotification() : super(method: Method.notificationsInitialized);

  factory JsonRpcInitializedNotification.fromJson(Map<String, dynamic> json) => const JsonRpcInitializedNotification();
}
